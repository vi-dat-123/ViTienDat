...
public class AddWord extends javax.swing.JDialog {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtViet, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                            .addComponent(txtEng)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(68, 68, 68)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String viet = txtViet.getText();
        boolean isOk = true;
        if(eng.length() == 0 || viet.length() == 0){
            JOptionPane.showMessageDialog(rootPane, "Thêm từ không thành công");
            isOk = false;
        }
        if(isOk){
            Word l = new Word(eng, viet);
            home.addWord(l);
        }
